...
class YoutubeApi:
    ...
    def playlists_create(self, data):
        ...
        headers = [
            ...
            'x-youtube-utc-offset: 480',
            'cookie: VISITOR_INFO1_LIVE=agupQC2ljlo; PREF=f1=50000000&al=zh-CN&f5=30; CONSENT=YES+HK.zh-CN+201905; _ga=GA1.2.407811703.1566026452; endscreen-metadata-editor-gh=true; SID=nwcX73pwnHEunJwg-8RIK8Bj3qyPPMl9mDNaCZ4vBe0dfYJ7oAXGgj0XBoh8ghQy-E7L0w.; HSID=APPfQY5DI5m5ax9N5; SSID=ACKQB7w4vu58gL4Dg; APISID=eUN5NWiOuWdhzSDC/AYWSTe5v0DXN9mHdY; SAPISID=ghmi7ZcFW5UpRdaI/AMHNH4mJ3imfgxbRv; YSC=opUK8tDkb8c; LOGIN_INFO=AFmmF2swRQIhAO82BzFYCqtddP-UKkkEmxnJtjBoZc7wTR5pH2jJDgXNAiA6HRlY8AOuwn3xj2oVK-zNplOqNJ7d7rmrQ-cpvhl00A:; SIDCC=AN0-TYuUma4cufS4ZR9r7Tcl4L0hflx9kw3VTVsSCPiuA9UFft_DLx-wiY-A3SWPasxkVhX-',
            'x-client-data: CIi2yQEIorbJAQipncoBCKijygEIsafKAQjiqMoBCPGpygEIzK7KAQ==',
    ...
    def set_playlist_description(self, data):
        ...
        headers = [
            ...
            'x-youtube-page-cl: 266331450',
            'x-youtube-utc-offset: 480',
            'cookie: VISITOR_INFO1_LIVE=agupQC2ljlo; PREF=f1=50000000&al=zh-CN&f5=30; CONSENT=YES+HK.zh-CN+201905; _ga=GA1.2.407811703.1566026452; endscreen-metadata-editor-gh=true; SID=nwcX73pwnHEunJwg-8RIK8Bj3qyPPMl9mDNaCZ4vBe0dfYJ7oAXGgj0XBoh8ghQy-E7L0w.; HSID=APPfQY5DI5m5ax9N5; SSID=ACKQB7w4vu58gL4Dg; APISID=eUN5NWiOuWdhzSDC/AYWSTe5v0DXN9mHdY; SAPISID=ghmi7ZcFW5UpRdaI/AMHNH4mJ3imfgxbRv; YSC=opUK8tDkb8c; LOGIN_INFO=AFmmF2swRQIhAO82BzFYCqtddP-UKkkEmxnJtjBoZc7wTR5pH2jJDgXNAiA6HRlY8AOuwn3xj2oVK-zNplOqNJ7d7rmrQ-cpvhl00A:; SIDCC=AN0-TYt-CXsklBhAhGdTFsjOidA1wge5IQZyBhD08mUZY-EEGrMwcHJV_oMPmihA07ofzf3O',
            'x-client-data: CIi2yQEIorbJAQipncoBCKijygEIsafKAQjiqMoBCPGpygEIzK7KAQ==',
            'x-youtube-ad-signals: dt=1567512261776&flash=0&frm&u_tz=480&u_his=2&u_java&u_h=1080&u_w=1920&u_ah=1018&u_aw=1920&u_cd=24&u_nplug=3&u_nmime=4&bc=31&bih=414&biw=1905&brdim=0%2C28%2C0%2C28%2C1920%2C28%2C1920%2C1018%2C1920%2C414&vis=1&wgl=true&ca_type=image&bid=ANyPxKpKHSfS1GlgA_S7ftPGeBlZAK8PTUApkto5LgHTXUq7YsXAKnK9nmvsvIMOHvuGcpNDM-f7wsQVYuB5Nmma10kPUUdvJw',
            'x-youtube-client-version: 1.20190830.05.01',
            'user-agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36',
            'x-youtube-variants-checksum: 694bb84093276e0ae66c65ac90e36fd4',
            'content-type: application/x-www-form-urlencoded',
            'accept: */*',
            'referer: https://www.youtube.com/playlist?list=PLljKjXpjNpgeDzs_IhGGE0xCiiktwzP3a&disable_polymer=true',
            'x-youtube-client-name: 1',
            'authority: www.youtube.com',
            'x-youtube-identity-token: QUFFLUhqbld6VjhQM3BlaFdCZUZGUXk3dldTQXhBTE9EQXw=',
            'dnt: 1',
    ...
    def video_description_update(self, data):
        ...
        headers = [
            'cookie: VISITOR_INFO1_LIVE=agupQC2ljlo; PREF=f1=50000000&al=zh-CN&f5=30; CONSENT=YES+HK.zh-CN+201905; _ga=GA1.2.407811703.1566026452; endscreen-metadata-editor-gh=true; SID=nwcX73pwnHEunJwg-8RIK8Bj3qyPPMl9mDNaCZ4vBe0dfYJ7oAXGgj0XBoh8ghQy-E7L0w.; HSID=APPfQY5DI5m5ax9N5; SSID=ACKQB7w4vu58gL4Dg; APISID=eUN5NWiOuWdhzSDC/AYWSTe5v0DXN9mHdY; SAPISID=ghmi7ZcFW5UpRdaI/AMHNH4mJ3imfgxbRv; YSC=opUK8tDkb8c; LOGIN_INFO=AFmmF2swRQIhAO82BzFYCqtddP-UKkkEmxnJtjBoZc7wTR5pH2jJDgXNAiA6HRlY8AOuwn3xj2oVK-zNplOqNJ7d7rmrQ-cpvhl00A:; SIDCC=AN0-TYtymhwC0ralNwWv660cenVgNclDlfqrsdOSvXkje9WjOzFxvWyJ_4wl8R9KY5Zzgriv',
            'origin: https://studio.youtube.com',
            'x-origin: https://studio.youtube.com',
            'accept-language: zh-CN,zh;q=0.9,en-GB;q=0.8,en;q=0.7,en-US;q=0.6,zh-HK;q=0.5,zh-TW;q=0.4',
            'authorization: SAPISIDHASH 1567595994_da25c8716847a50b6e62c4ffb0ece7871407d470',
            'x-youtube-utc-offset: 480',
            'x-client-data: CIi2yQEIorbJAQipncoBCKijygEIsafKAQjiqMoBCPGpygEIzK7KAQ==',
            'x-goog-authuser: 0',
            'user-agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36',
